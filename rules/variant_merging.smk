...
rule merge_variant_callers:
    ...
    output: not_filtered_vcf = "germinal_varcalls/{sample_name}.raw_calls.vcf",
            vcf= "germinal_varcalls/{sample_name}.final_variants.vcf",
            tsv = "germinal_varcalls/{sample_name}.final_variants.tsv"
